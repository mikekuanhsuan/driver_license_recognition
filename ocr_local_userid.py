...
def read_userid(path,key,region,endpoint):
    ...
    for wordall in word_infos:
        ...
        if(  bounding_x > x_start and bounding_x < x_end and bounding_y < y_end  ):
    ...
    # ================
    address="".join(newbox)
    cleantext = re.sub('[\u4e00-\u9fa5\W]+', '', address) 
